...
const Adminview = () => {
  return (
    <div>
      ...
      <ul style={{maxWidth:'1200px' , marginLeft: '180px', fontFamily: 'montserrat', marginTop: '30px', 
      ...
      <div className='examSection' id='mockexams'>
        ...
        <div className='examBottom'>
          <div className='examCards'>
            <img src='https://www.itepexam.com/wp-content/uploads/2019/10/Header-1024x801.png'></img>
